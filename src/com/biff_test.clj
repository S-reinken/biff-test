(ns com.biff-test
  (:require [com.biffweb :as biff]
            [com.biff-test.email :as email]
            [com.biff-test.app :as app]
            [com.biff-test.home :as home]
            [com.biff-test.middleware :as mid]
            [com.biff-test.ui :as ui]
            [com.biff-test.worker :as worker]
            [com.biff-test.schema :as schema]
...
(defn on-save [ctx]
  ...
  (biff/eval-files! ctx)
  (generate-assets! ctx)
  (biff/catchall (require 'com.biff-test-test))
  (test/run-all-tests #"com.biff-test.*-test"))
