...
(comment
  ...
  (get-context)
  (let [{:keys [com.biff-test/trello-clients]} (get-context)]
    @trello-clients)

  (uuid? "3f42308f-140c-48c5-8747-d2a5a100a6f6")
  (java.util.UUID/fromString "3f42308f-140c-48c5-8747-d2a5a100a6f6")
